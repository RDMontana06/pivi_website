						...
						<div class="portfolio-details-slider swiper">
							<div class="swiper-wrapper align-items-center">
								...
								<div class="swiper-slide">
									<img src="{{ asset('img/about/PCHI/1.jpg') }}" alt="">
								</div>

								<div class="swiper-slide">
									<img src="{{ asset('img/about/PCHI/2.jpg') }}" alt="">
								</div>

								<div class="swiper-slide">
									<img src="{{ asset('img/about/PCHI/3.jpg') }}" alt="">
								</div>
								<div class="swiper-slide">
									<img src="{{ asset('img/about/PCHI/4.jpg') }}" alt="">
								</div>
								<div class="swiper-slide">
									<img src="{{ asset('img/about/PCHI/5.jpg') }}" alt="">
								</div>
								<div class="swiper-slide">
									<img src="{{ asset('img/about/PCHI/6.jpg') }}" alt="">
								</div>
